...
; BLOG: the static blog.
(define BLOG
  (list (post "First post" "Hello, world!")
        (post "Second post" "I don't know what to say")
        (post "Third post" "Lorem ipsum")
        (post "Fourth post" "The quick brown fox jumped over the lazy bone")))
